...
do
	...
	function library.new(title)
		local container = utility:Create("ScreenGui", {
			...
			utility:Create("ImageLabel", {
				...
				Position = UDim2.new(0.1, 0, 0.052435593, 0),
				Size = UDim2.new(0, 354, 0, 428),
				Image = "rbxassetid://4641149554",
				ImageColor3 = Color3.fromRGB(21, 31, 44),
				...
				utility:Create("ImageLabel", {
					...
					ImageColor3 = Color3.fromRGB(24, 36, 51),
					ScaleType = Enum.ScaleType.Slice,
					SliceCenter = Rect.new(4, 4, 296, 296)
				}, {
		...
		container.Main.TopBar.Menu.MouseButton1Click:Connect(function()
			if navToggled then
				navToggled = not navToggled
				utility:Tween(container.Main.Pages, {
					Size = UDim2.new(0, 40, 1, -38),
				}, 0.2)
			else
				navToggled = not navToggled
		...
		return setmetatable({
			container = container,
			pagesContainer = container.Main.Pages.PagesContainer,
			pages = {}
		}, library)
	end
	...
	function page.new(library, title, icon)
		...
		local container = utility:Create("ScrollingFrame", {
			...
			Size = UDim2.new(1, -55,1, -56),
			CanvasSize = UDim2.new(0, 0, 0, 466),
			ScrollBarThickness = 3,
			ScrollBarImageColor3 = Color3.fromRGB(44, 56, 81),
			Visible = false
		}, {
			utility:Create("UIListLayout", {
				SortOrder = Enum.SortOrder.LayoutOrder,
	...
	function library:toggle()
		...
		if self.position then
			...
			utility:Tween(topbar, {Size = UDim2.new(1, 0, 0, 38)}, 0.05)
			wait(0.05)
	...
	function section:addToggle(title, default, callback)
		local toggle = utility:Create("ImageButton", {
			...
			utility:Create("ImageLabel", {
				...
				ZIndex = 2,
				Image = "rbxassetid://5028857472",
				ImageColor3 = Color3.fromRGB(25, 38, 53),
				ScaleType = Enum.ScaleType.Slice,
				SliceCenter = Rect.new(2, 2, 298, 298)
			}, {
				utility:Create("ImageLabel", {
		...
		local tab = utility:Create("ImageLabel", {
			...
			utility:Create("Frame", {
				...
				utility:Create("ImageButton", {
					Name = "Canvas",
					BackgroundTransparency = 1,
					BorderColor3 = Color3.fromRGB(25, 38, 53),
				...
				utility:Create("Frame", {
					...
					utility:Create("ImageLabel", {
						...
						utility:Create("TextBox", {
							...
							ZIndex = 2,
							Font = Enum.Font.Gotham,
							PlaceholderColor3 = Color3.fromRGB(21, 31, 44),
							Text = "255",
							TextColor3 = themes.TextColor,
							TextSize = 10.000
						})
		...
		local dropdown = utility:Create("Frame", {
			...
			utility:Create("ImageLabel", {
				...
				utility:Create("ScrollingFrame", {
					...
					ZIndex = 2,
					ScrollBarThickness = 3,
					ScrollBarImageColor3 = Color3.fromRGB(21, 31, 44)
				}, {
					utility:Create("UIListLayout", {
						SortOrder = Enum.SortOrder.LayoutOrder,
						Padding = UDim.new(0, 4)
	...
	function section:Resize(smooth)
		...
		if smooth then
			utility:Tween(self.container.Parent, {Size = UDim2.new(1, -5, 0, size)}, 0.05)
		else
			self.container.Parent.Size = UDim2.new(1, -5, 0, size)
			self.page:Resize()
		end
	end
	...
	function section:updateButtonColor(button, color)
		button = self:getModule(button)

		button.Title.TextColor3 = color
	end
